...
##### FROM FILES
tedx_dataset_path = "s3://tedx-2026-data-mp/final_list.csv"
...
## READ THE DETAILS
details_dataset_path = "s3://tedx-2026-data-mp/details.csv"
...
## READ TAGS DATASET
tags_dataset_path = "s3://tedx-2026-data-mp/tags.csv"
